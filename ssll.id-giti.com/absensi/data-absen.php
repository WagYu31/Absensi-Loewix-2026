...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Jika form belum disubmit, gunakan bulan dan tahun sebelumnya
    $currentMonth = date('m');
    $currentYear = date('Y');
    ...
    <div class="container form-container">
        <div class="row mb-3">
            ...
            <div class="col-3 text-right">
                <a href="validasi-absen.php?bulan=<?php echo $bulan; ?>&tahun=<?php echo $tahun; ?>" class="btn-primary bt-data">Data Ini Sudah Benar</a>
            </div>
        </div>
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <!--<th colspan="2">Setengah Hari</th>-->
                    <th rowspan="2" class="text-center align-middle" style="background:#ddd;">Total Denda</th>
                </tr>
                <tr>
                    <th>Shifting</th> 
                    <th>Menit</th>
