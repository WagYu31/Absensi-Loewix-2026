            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr>";
                        echo "<td style='text-align:left;'><b>" . $hari_scan1 . ", " . $tgl_only . "</b><br>";
                        ...
                        echo "Masuk : " . $jam_scan . "<br>";
                        echo "Pulang : " . $jam_out . "<br>";
                        ...
                        echo "Terlambat : " . $keterlambatan_menit . " menit" . "<br>";
                        ...
                        if ($tgl_scan == "<span class='text-danger'>Tidak Absen Masuk</span>" || $tgl_out == "<span class='text-danger'>Tidak Absen Pulang</span>") {
                            echo "Bekerja selama : - <br>";
                            $jam = 0;
                            $menit = 0;
                            $detik = 0;
                        } else {
                            echo "Bekerja selama : " . $jam . " jam " . $menit . " menit " . $detik . " detik" . "<br>";
                        }
                    ...
                    echo "<tr>";
                    echo "<td><b>TOTAL KERJA 1 BULAN [" . $no . "Hari]</b><br>";
                    echo "<b>" . $totalJam . " jam " . $totalMenit . " menit " . $totalDetik . " detik" . "</b></td>";
                    echo "</tr>";
                } else {
        ...
        echo "<div class='col-md-6' style='margin-top: 2vh;'>";
        echo "<div class='card card-custom shadow-sm'>";
        ...
        echo "<div class='row mb-5' style='margin-top: 2vh;'>";
        ...
        echo "<div class='col-md-7' style='margin-top: 2vh;'>";
        echo "<div class='card card-custom shadow-sm'>";
        echo "<div class='card-body card-body-custom d-flex flex-column justify-content-center align-items-center text-center'>";
