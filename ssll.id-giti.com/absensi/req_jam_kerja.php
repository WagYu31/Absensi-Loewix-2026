...
$query = "SELECT izin_jam_kerja.*, karyawan.nama, karyawan.pin_absen AS pin, karyawan.nik
        FROM izin_jam_kerja 
        JOIN karyawan ON karyawan.pin_absen = izin_jam_kerja.nip";

// Tambahkan kondisi filter berdasarkan bulan dan tahun jika telah dipilih
if (!empty($bulan) && !empty($tahun)) {
    $query .= " WHERE MONTH(izin_jam_kerja.tgl_izin) = ? AND YEAR(izin_jam_kerja.tgl_izin) = ?";
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-6 form-container">
                <h2>Request Jam Kerja</h2>
                <form method="post" action="update_req_setengah_hari.php">
                    ...
                    <div class="form-group">
                        <label for="tanggal_mulai">Tanggal Request</label>
                        <input type="date" class="form-control" id="tanggal_mulai" name="tgl_req" required>
                    </div>
                    <div class="form-group">
                        <label for="shift">Izin Pada</label>
                        <select class="form-control" id="shift" name="pada" required>
                            <option value="1">Awal Jam (Jam Masuk)</option>
                            <option value="2">Akhir Jam (Jam Keluar)</option>
                        </select>
                    </div>
            ...
            <div class="col-6 form-container-2">
                ...
                <table id="denda">
                    <tr>
                        ...
                        <th onclick="sortTable(2)">Tanggal Izin</th>
                        <th onclick="sortTable(3)">Pada Jam</th>
    ...
    <script>
        function confirmDelete(id) {
            if (confirm("Are you sure you want to delete this data?")) {
                ...
                window.location.href = "proses-delete-req-jam.php?id=" + id; // Change 'id' to 'id_denda'
            }
        }
