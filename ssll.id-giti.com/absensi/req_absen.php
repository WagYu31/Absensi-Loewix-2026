        ...
        <div class="row">
            <div class="col-6 form-container">
                ...
                <form method="post" action="update_req_absen.php">
                    ...
                    <div class="form-group">
                        <label for="jam">Absen Manual di Jam</label>
                        <select class="form-control" id="jam" name="jam" required>
                            ...
                            <option value="18:00:00">Pulang Shift Harco (18:00)</option>
            ...
            <div class="col-6 form-container-2">
                ...
                <table id="denda">
                    ...
                    foreach ($dataa as $data) {
                        ...
                        echo "<td class='hide-m' style='text-align:left;'>" . $data['jam'] . "</td>";
                        echo "<td>";
    ...
    <script>
        function confirmDelete(id) {
            if (confirm("Are you sure you want to delete this data?")) {
                ...
                window.location.href = "proses-delete-req-absen.php?id=" + id; // Change 'id' to 'id_denda'
            }
        }
