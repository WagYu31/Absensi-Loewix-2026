...
if (isset($_POST['nip_denda']) && isset($_POST['tanggal_denda']) && isset($_POST['jumlah_denda']) && isset($_POST['keterangan_denda'])) {
    ...
    //     echo "Data sudah di kunci!";
    // }
    // else{

    // Query untuk menambahkan data denda ke tabel denda
    $query = "INSERT INTO tunjangan_lainnya (nip, tanggal, ket1, jumlah, keterangan) VALUES ('$nipDenda', '$tanggalDenda', 'bonus', '$jumlahDenda', '$keteranganDenda')";
    ...
    if ($conn->query($query) === TRUE) {
        ...
        if ($resultCheck->num_rows > 0) {
            ...
            $queryInsert = "INSERT INTO rincian_gaji (nip, tanggal, tunjangan_lainnya) VALUES ('$nipDenda', '$tanggalDenda', '$jumlahDenda')";
        ...
        $message = "Success!";
        echo "<script>alert('$message'); window.location.href = 'sa-bonus.php';</script>";
        exit();
    } else {
