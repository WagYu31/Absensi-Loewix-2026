...
<head>
    ...
    <script type="text/javascript" src="js/script-download-ganti.js"></script>
    ...
    $query = "SELECT tunjangan_lainnya.*, karyawan.nama, karyawan.nik
    ...
    if (!empty($bulan) && !empty($tahun)) {
        $query .= " WHERE MONTH(tunjangan_lainnya.tanggal) = '$bulan' AND YEAR(tunjangan_lainnya.tanggal) = '$tahun' AND tunjangan_lainnya.ket1 = 'ganti'";
    }
    ...
    <form method="post">
        ...
        <div class="row" style="height: auto !important;">
            <table id="employees" class="table table-striped">
                <tr>
                    <th colspan="6" class="judul">Laporan Biaya Pengganti</th>
                </tr>
                <tr>
                    ...
                    <th width="11%">Biaya Pengganti</th>
                    <th width="7%" class="th no-print">Aksi</th>
                </tr>
                <?php
                $sum = 0;
                $totalSUM = 0;
                ...
                <tr>
                    ...
                    <button class="gnt" onclick="deleteGanti('<?php echo $data['id_tunjangan_lain']; ?>')"><i class="fas fa-trash"></i></button>
                    </td>
                </tr>
            <?php endwhile; ?>
                <tr>
                    ...
                    <td class="hide-m"></td>
                    <td class="hide-m"></td>
                    <td class="total" style="text-align:center;"><?php echo $totalSUM; ?></td>
                    <td class="hide-m"></td>
                </tr>
        </table>
    </div>
...
<script>
    function deleteGanti(id_tunjangan_lain) {
        if (confirm("Are you sure you want to delete this data?")) {
            ...
            window.location.href = "sa-proses-hapus-ganti.php?id_tunjangan_lain=" + id_tunjangan_lain; // Change 'id' to 'id_denda'
        }
      }
    function tampilkanData() {
        var bulan = document.getElementById("bulan").value;
        var tahun = document.getElementById("tahun").value;
        window.location.href = "laporan-pengganti.php?bulan=" + bulan + "&tahun=" + tahun;
    }
    </script>
</body>
</html>
