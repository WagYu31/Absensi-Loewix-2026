function exportToExcel() {
    ...
    var filename = 'Laporan_Cashbon_' + selectedMonthName + '_' + selectedYear + '.xls';
...
function exportToCSV() {
    ...
    var filename = 'Laporan_Cashbon_' + selectedMonthName + '_' + selectedYear + '.csv';
...
function exportToTXT() {
    ...
    var filename = 'Laporan_Cashbon_' + selectedMonthName + '_' + selectedYear + '.txt';
