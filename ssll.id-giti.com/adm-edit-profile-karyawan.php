    ...
    if (isset($_FILES['gambar_ktp']) && $_FILES['gambar_ktp']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($tmp_name, $target_file)) {
            ...
            if ($conn->query($query) === TRUE) {
                ...
                $message = "Success";
                echo "<script>alert('$message'); window.location.href = 'view-profile.php?nip=$nip';</script>";
                exit();
...
//     $queryUpdate = "UPDATE karyawan SET 
//         nama = '$updatedNama',
//         nik = '$updatedNik',
//         jabatan = '$updateJabatan',
//         tempat_lahir = '$updatedTempatLahir',
//         tanggal_lahir = '$updatedTanggalLahir',
//         alamat = '$updatedAlamat',
//         nomor_handphone = '$updatedNomorHandphone',
//         nomor_telepon = '$updatedNomorTelepon',
//         email = '$updatedEmail',
//         tanggal_masuk = '$updatedTanggalMasuk',
//         nomor_ktp = '$updatedNomorKTP',
//         nama_bank = '$updatedNamaBank',
//         nomor_rekening = '$updatedNomorRekening',
//         nama_pemilik_rekening = '$updatedNamaPemilikRekening'
//     WHERE nip = '$nip'";

//     if ($conn->query($queryUpdate) === TRUE) {
//         // Redirect to view profile page with updated data
//         header("Location: view-profile.php?nip=$nip");
//         exit();
//     } else {
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/style-sa-edit-profile.css">
...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="hide-c">
            ...
            <tr>
                <td>Gaji Pokok</td>
                <td><input type="text" name="gaji_pokok" value="Rp *******" disabled></td>
            </tr>
            <tr>
                <td>Tunjangan Jabatan</td>
                <td><input type="text" name="tunjangan" value="Rp ******" disabled></td>
            </tr>
            <tr>
                <td>Tanggal Masuk</td>
