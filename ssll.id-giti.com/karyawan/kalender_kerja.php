...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/absen-styles.css?v=<?php echo $asset_version; ?>">
    ...
    <div class="main-content-wrapper p-0">
        <div class="header-banner page-specific-header no-print">
            <div class="container-fluid px-lg-4">
                ...
                <p class="small mb-0 opacity-80">Cek hari libur, acara khusus perusahaan, dan lihat ulang tahun rekan kerja Anda.</p>
            </div>
        </div>
                            ...
                            <div class="bday-card-item">
                                <div class="d-flex align-items-center gap-3" style="min-width: 0;">
                                    <div class="bday-avatar-ring">
                                        ...
                                        $bemp_svg = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='50' height='50' viewBox='0 0 50 50'><rect width='50' height='50' rx='25' fill='%232563eb'/><text x='50%' y='55%' dominant-baseline='middle' text-anchor='middle' fill='%23ffffff' font-family='sans-serif' font-size='20' font-weight='bold'>{$bemp_initial}</text></svg>";
                                        ?>
