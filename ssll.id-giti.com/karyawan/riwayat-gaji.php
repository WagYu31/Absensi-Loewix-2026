...
<body>
        ...
        <div class="dashboard-content slip-gaji-content">
            <div class="container-fluid px-lg-4 px-1">
                ...
                <div class="card mb-4 no-print filter-slip-card">
                    <div class="card-body">
                        <form method="POST" action="riwayat-gaji.php" class="row gx-2 gy-3 align-items-end">
    ...
    <script>
        $(document).ready(function() {
            ...
            if (currentPath === "riwayat-gaji.php" && !$('.sidebar-menu a[href="riwayat-gaji.php"]').hasClass('active')) {
                $('.sidebar-menu a.active').removeClass('active');
                $('.sidebar-menu a[href="riwayat-gaji.php"]').addClass('active');
            }
