...
if (!empty($bulan) && !empty($tahun)) {
    $query .= " WHERE MONTH(tunjangan_lainnya.tanggal) = ? AND YEAR(tunjangan_lainnya.tanggal) = ? AND tunjangan_lainnya.ket1 = 'ganti'";
...
<body>
    ...
    <div class="containt">
        <form action="proses-tambah-data-tunjangan-lainnya-karyawan.php" method="POST" enctype="multipart/form-data">
            <h2>Biaya Pengganti</h2>

            <label for="nip-tunjangan">Nama:</label>
            <select id="nip-tunjangan" name="nip_tunjangan" required>
                <?php
            ...
            <label for="tanggal-tunjangan">Tanggal:</label>
            <?php
            include 'conn.php';
            ...
            ?>
            <input type="date" id="tanggal-tunjangan" name="tanggal_tunjangan" onchange="checkLockedDates()" required>

            <label for="jumlah-tunjangan">Jumlah:</label>
            <input type="number" id="jumlah-tunjangan" name="jumlah_tunjangan" required>

            <label for="keterangan-tunjangan">Keterangan:</label>
            <textarea id="keterangan-tunjangan" name="keterangan_tunjangan" required></textarea>
            ...
            <table id="tunjangan">
                ...
                foreach ($dataa as $data) {
                    if ($data['ket1'] === 'ganti') {
                        ...
                        echo "<td>" . $jumlah . "</td>";
                        echo "<td>";
                        echo "<button onclick=\"deleteTunjangan('" . $data['id_tunjangan_lain'] . "')\">Delete</button></td>";
                        echo "</td>";
                        echo "</tr>";
                    }
                }
    ...
    <script>
        function sortTable(n) {
            ...
            table = document.getElementById("tunjangan");
            switching = true;
        ...
        function checkLockedDates() {
            var tanggalInput = document.getElementById("tanggal-tunjangan");
        ...
        function printData() {
            ...
            var url = "print-tunjangan.php?bulan=" + bulan + "&tahun=" + tahun;
