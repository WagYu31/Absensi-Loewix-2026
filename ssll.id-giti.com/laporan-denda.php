...
<head>
    ...
    $query = "SELECT denda.*, karyawan.nama, karyawan.nik
            FROM denda 
        ...
        <div class="row" style="height: auto !important;">
            <table id="employees" class="table table-striped">
                <tr>
                    ...
                    ?>
                    <th colspan="6" class="judul">Laporan Denda <?php echo $bulan . "/" . $tahun; ?></th>
                </tr>
                <tr>
                    <th class="hide-m" width="3%">NIK</th>
                    <th width="8%">Nama</th>
                ...
                <tr>
                    ...
                    <button onclick="deleteDenda('<?php echo $data['id_denda']; ?>')"><i class="fas fa-trash" id="c"></i></button>
                    </td>
                </tr>
            <?php endwhile; ?>
                <tr>
