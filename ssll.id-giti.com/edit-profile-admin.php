...
if (!isset($_SESSION["nip"]) || $_SESSION["role"] !== "admin") {
    header("Location: edit-profile-admin.php");
    exit();
}
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/style-riwayat-gaji.css">
...
<body>
    ...
    <div class="containt">
        ...
        <form action="save-profile-admin.php" method="POST" enctype="multipart/form-data" class="profile-form">
