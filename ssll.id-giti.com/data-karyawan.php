...
<body>
    ...
    <div class="content">
        <div class="header">
            <h3>Data Karyawan</h3>
            <a class="button-2" href="tambah-data-karyawan.php">Tambah Karyawan</a>
        </div>
        <table id="karyawan" style="margin-top:2%;">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                ?>
                    <tr class="<?php echo $highlightClass; ?>">
                        ...
                        <td>
                            <a href="view-profile.php?nip=<?php echo $karyawan['nip']; ?>" class="button2"><i class="fas fa-magnifying-glass"></i></a>
