...
<head>
    ...
    <style>
        ...
        /* Animated CCTV Running Character Banner */
        .cctv-runner-banner {
            background: linear-gradient(135deg, #0f172a 0%, #1e293b 60%, #1e3a8a 100%);
            border: 2px solid rgba(234, 179, 8, 0.4);
            border-radius: 20px;
            box-shadow: 0 10px 30px rgba(15, 23, 42, 0.25), 0 0 20px rgba(234, 179, 8, 0.15);
            overflow: hidden;
            position: relative;
        }
        ...
        .cctv-runner-track {
            ...
            width: 100%;
            height: 85px;
            background: radial-gradient(circle at bottom, rgba(59, 130, 246, 0.15) 0%, transparent 70%);
        ...
        .cctv-runner-character {
            ...
            align-items: center;
            animation: runAcrossTrack 10s linear infinite;
        }

        @keyframes runAcrossTrack {
            0% { left: -100px; transform: scaleX(1); }
            45% { left: calc(100% - 70px); transform: scaleX(1); }
        ...
        .cctv-nametag-float {
            ...
            white-space: nowrap;
            margin-bottom: 4px;
            animation: nameTagBounce 0.35s ease-in-out infinite alternate;
        }
        ...
        .cctv-red-light {
            ...
            animation: recBlink 0.6s ease-in-out infinite alternate;
        }
        ...
        .cctv-leg-anim.leg1 { animation: runLegLeft 0.22s linear infinite alternate; }
        .cctv-leg-anim.leg2 { animation: runLegRight 0.22s linear infinite alternate; }
    ...
    <div class="main-content-wrapper p-0">
        ...
        <div class="dashboard-content">
            <div class="container-fluid px-lg-4">
                ...
                <!-- CCTV Runner Character Property Animation Banner -->
                <div class="cctv-runner-banner mb-4">
                    <div class="d-flex align-items-center justify-content-between px-3 pt-3 pb-1 text-white">
                        <div class="d-flex align-items-center gap-2">
                            <span class="badge bg-warning text-dark fw-extrabold px-2.5 py-1 rounded-pill"><i class="fa-solid fa-crown me-1"></i> TOP PERFORMER</span>
                            <span class="fw-bold fs-6 text-warning">Edi Suprianto</span>
                            <small class="text-white-50 ms-2 d-none d-sm-inline">&bull; Property Karakter Animasi CCTV Runner</small>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <span class="rec-status-badge"><span class="rec-dot-live"></span> LIVE CCTV 4K</span>
                        </div>
                    </div>
                    <div class="cctv-runner-track">
                        <div class="cctv-runner-character">
                            <div class="cctv-nametag-float">
                                <i class="fa-solid fa-person-running me-1"></i> Edi Suprianto
                            </div>
                            <div class="cctv-head">
                                <div class="cctv-lens"></div>
                                <div class="cctv-red-light"></div>
                                <div class="cctv-glare"></div>
                            </div>
                            <div class="cctv-torso"></div>
                            <div class="cctv-legs-container">
                                <div class="cctv-leg-anim leg1"></div>
                                <div class="cctv-leg-anim leg2"></div>
                            </div>
                        </div>
                    </div>
                </div>
